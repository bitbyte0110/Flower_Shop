<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Christmas.aspx.cs" Inherits="Assg1.Christmas" MasterPageFile="~/Site1.Master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form id="form1" runat="server">
        ...
        <h1 class="text-center mt-4">Christmas Flowers</h1>
        <!-- Product List -->
