<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Romance.aspx.cs" Inherits="Assg1.Romance" MasterPageFile="~/Site1.Master" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Romance Products</title>
    <style>
        .product-list {
            display: grid;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form id="form1" runat="server">
        ...
        <h1 class="text-center mt-4">Romance Flowers</h1>
        <!-- Product List -->
