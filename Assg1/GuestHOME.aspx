<%@ Page Title="" Language="C#" MasterPageFile="~/Guest.Master" AutoEventWireup="true" CodeBehind="GuestHOME.aspx.cs" Inherits="Assg1.GuestHOME" %>
        ...
        <div class="container">
            ...
            <div class="testimonial-slider" role="region" aria-label="Customer Testimonials">
                <div class="testimonial-card">
                    ...
                    <p itemprop="reviewBody" class="testimonial-text">
                    ...
                    <div class="customer-info" itemprop="author">
                        ...
                        <div class="customer-details">
                            <span itemprop="name" class="customer-name">Sarah M.</span>
                            <span class="customer-badge verified-buyer">Verified Buyer</span>
                            <small class="review-date" itemprop="datePublished">Reviewed on January 15, 2024</small>
                        </div>
                    </div>
                ...
                <div class="testimonial-card">
                    ...
                    <div class="customer-info" itemprop="author">
                        ...
                        <div class="customer-details">
                            <span itemprop="name" class="customer-name">Michael T.</span>
                            <span class="customer-badge verified-buyer">Verified Buyer</span>
                            <small class="review-date" itemprop="datePublished">Reviewed on February 3, 2024</small>
                        </div>
                    </div>
                    <div class="product-context" itemprop="itemReviewed">
                ...
                <div class="testimonial-card">
                    ...
                    <div class="customer-info" itemprop="author">
                        ...
                        <div class="customer-details">
                            <span itemprop="name" class="customer-name">David R.</span>
                            <span class="customer-badge verified-buyer">Verified Buyer</span>
                            <small class="review-date" itemprop="datePublished">Reviewed on March 10, 2024</small>
                        </div>
                    </div>
                    <div class="product-context" itemprop="itemReviewed">
